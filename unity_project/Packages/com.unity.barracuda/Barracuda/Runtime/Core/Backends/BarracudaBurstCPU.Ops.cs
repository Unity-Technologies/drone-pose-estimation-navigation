...
public partial class BurstCPUOps
{
    ...
    public override Tensor Dense3(Tensor X, Tensor W, Tensor B)
    {
        ...
        job.dispatchThreadX = ((xh + Dense3Job_Float.blockSize - 1) / Dense3Job_Float.blockSize);
        job.dispatchThreadY = ((yw + Dense3Job_Float.blockSize - 1) / Dense3Job_Float.blockSize);
        job.dispatchThreadZ = xb;
