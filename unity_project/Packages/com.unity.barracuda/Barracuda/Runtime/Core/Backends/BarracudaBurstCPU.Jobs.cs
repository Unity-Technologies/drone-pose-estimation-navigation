...
public partial class BurstCPUOps
{
    ...
    [BurstCompile]
    internal unsafe struct ReadOnlyMemResourceHalf
    {
        [NoAlias][NativeDisableUnsafePtrRestriction][ReadOnly] public half* ptr;
        internal ReadOnlyMemResourceHalf(half* _ptr) => ptr = _ptr;
    }

    [BurstCompile]
    internal unsafe struct ReadWriteMemResourceHalf
    {
        [NoAlias][NativeDisableUnsafePtrRestriction]           public half* ptr;
        internal ReadWriteMemResourceHalf(half* _ptr) => ptr = _ptr;
    }
...
// inlining or introduce a branch here in the inner loop
    ...
    [BurstCompile(OptimizeFor = OptimizeFor.Performance, FloatMode = FloatMode.Fast, FloatPrecision = FloatPrecision.Low)]
    unsafe struct Border2DJob : IJobParallelFor, IJobResourceDeclarationXO
    {
        public ReadOnlyMemResource X { get; set; }
        public ReadWriteMemResource O { get; set; }
        [ReadOnly] public TensorShape shapeO;
        ...
        public void Execute(int i)
        {
            ...
            int readX = w - PadWidth;
            int readY = h - PadHeight;
            int readC = c - PadChannels;
            ...
            {
                v = X.ptr[shapeX.Index(n, readY, readX, readC)];
            }
    ...
    [BurstCompile(OptimizeFor = OptimizeFor.Performance, FloatMode = FloatMode.Fast, FloatPrecision = FloatPrecision.Low)]
    unsafe struct Pad2DEdgeJob : IJobParallelFor, IJobResourceDeclarationXO
    {
        public ReadOnlyMemResource X { get; set; }
        public ReadWriteMemResource O { get; set; }
        [ReadOnly] public TensorShape shapeO;
        ...
        public void Execute(int i)
        {
            ...
            readX = math.min(readX, shapeX.width - 1);
            readY = math.min(readY, shapeX.height - 1);
            readC = math.min(readC, shapeX.channels- 1);

            O.ptr[i] = X.ptr[shapeX.Index(n, readY, readX, readC)];
        }
    }

    [BurstCompile(OptimizeFor = OptimizeFor.Performance, FloatMode = FloatMode.Fast, FloatPrecision = FloatPrecision.Low)]
    unsafe struct Pad2DReflectJob : IJobParallelFor, IJobResourceDeclarationXO
    {
        public ReadOnlyMemResource X { get; set; }
        public ReadWriteMemResource O { get; set; }
        [ReadOnly] public TensorShape shapeO;
        ...
        public void Execute(int i)
        {
            ...
            int lastXIndex = shapeX.width - 1;
            int lastYIndex = shapeX.height - 1;
	        int lastCIndex = shapeX.channels - 1;
    ...
    [BurstCompile(OptimizeFor = OptimizeFor.Performance, FloatMode = FloatMode.Fast, FloatPrecision = FloatPrecision.Low)]
    unsafe struct Pad2DSymmetricJob : IJobParallelFor, IJobResourceDeclarationXO
    {
        public ReadOnlyMemResource X { get; set; }
        public ReadWriteMemResource O { get; set; }
        [ReadOnly] public TensorShape shapeO;
