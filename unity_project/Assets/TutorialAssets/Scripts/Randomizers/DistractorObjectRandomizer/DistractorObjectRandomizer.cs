...
public class DistractorObjectRandomizer : Randomizer
{
    ...
    private GameObject GenerateObject(GameObject prefab)
    {
        ...
        obj.AddComponent<ObjectPositionRandomizerTag>();
        obj.AddComponent<RotationRandomizerTag>();
        obj.AddComponent<ColorRandomizerTag>();
        obj.AddComponent<HueOffsetRandomizerTag>();
        obj.AddComponent<TextureRandomizerTag>();
        return obj;
    }
