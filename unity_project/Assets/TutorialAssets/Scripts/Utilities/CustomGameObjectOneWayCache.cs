...
namespace UnityEngine.Perception.Randomization.Randomizers.Utilities
{
    ...
    /// </summary>
    public class CustomGameObjectOneWayCache
    {
        ...
        /// <summary>
        /// Creates a new CustomGameObjectOneWayCache
        /// </summary>
        ...
        public CustomGameObjectOneWayCache(Transform parent, GameObject[] prefabs)
        {
