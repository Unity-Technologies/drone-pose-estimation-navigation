...
class Logger:
    ...
    def log_training(
        ...
        *,
        ...
        """
        Write the training translation error in the writer object to
    ...
    def log_evaluation(
        ...
        *,
        ...
        """
        Write the evaluatin translation error in the writer object to
        print it out on tensorboard for each epoch. It is the validation translation 
        error if we evaluate on the validation dataset and it is the test translation 
